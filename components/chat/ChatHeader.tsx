...
export default function ChatHeader({
  ...
  return (
    <div className="p-4 bg-white/90 backdrop-blur-md border-b border-slate-100 flex items-center justify-between shadow-xs">
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            {room?.isGroup ? (
              <span className="text-[10px] uppercase font-bold text-amber-700 bg-amber-100/80 px-2 py-0.5 rounded-full border border-amber-200/60">
                Group
              </span>
            ) : (
      ...
      <div className="flex items-center gap-1.5 text-slate-400">
        <button
          className="p-2 rounded-xl hover:bg-slate-100 hover:text-slate-700 transition cursor-pointer"
          title="Voice Call"
        >
